...
| `browse-marketplace` | Search and filter the public marketplace for remixable presentations, apps, and plans. No API key required. |
...
| `publish-to-marketplace` | Publish a pushed deck to the public marketplace as a `presentation`, `app`, or `plan`. Requires a key with the `marketplace:publish` scope. |
